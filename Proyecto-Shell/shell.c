...
int main(int argc, char* argv[])
{
    ...
    while(exitflag==0)
    {
        ...
        else if(strcmp(argval[0],"pause")==0)
        {
            function_pause();
        }
        else if(strcmp(argval[0],"welcome")==0 && !inBackground)
        {
            welcome();
        }
        else if(strcmp(argval[0],"help")==0 && !inBackground)
        {
            help();
        }
        ...
        else if(strcmp(argval[0],"clr")==0 && !inBackground)
        {
            function_clear();
        }
...
void help()
{
    char* descr = "Instructions to support :\n cd <dir>                                 - Done cd\n pwd                                      - Done pwd\n mkdir <dir>                              - Done mkdir\n rmdir <dir>                              - Done rmdir\n ls (support ls -l)                       - Done ls & -l\n cp <file1> <file2>                       - Done cp\n exit                                     - Done exit\n  execute any other command like ./a.out   - Done exec\n support background execution - &          - Done & redirect input output >, <                - Done\n a.out | b.out - must support a| b| c     - Done\n Additional - clear\n Additional - screenfetch\n Additional - up down keys, history- ?\n Additional - tab keys autocompletiton\n \n\n";
